...
import type { ToastActionElement, ToastProps } from "@/platform/ui/components/toaster/toast";
import { handleErrorMessages } from "@/platform/errors/handle-error-messages";
...
function toastFn({ ...props }: Toast) {
  ...
  const update = (propsWithId: ToasterToast) =>
    dispatch({
      type: "UPDATE_TOAST",
      toast: { ...propsWithId, id },
    });
