...
const FilterToolbarDesktopView = ({ Components, showReset, onReset, disabled }: ViewType) => {
  return (
...
export const FilterToolBarMobileView = ({ Components, showReset, onReset, disabled }: ViewType) => {
  return (
