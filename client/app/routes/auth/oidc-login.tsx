...
import { deriveLocalizationBaseUrl, deriveIdpBaseUrl } from "@/lib/blocks-url.util";
      ...
      <div className="overflow-hidden rounded-2xl border border-[hsl(var(--border-default))] bg-[hsl(var(--card))] shadow-md">
        ...
        <div className="flex flex-col gap-3 bg-[hsl(var(--surface-app))] px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex w-fit items-center gap-1.5 rounded-lg border border-[hsl(var(--border-default))] bg-[hsl(var(--card))] px-3 py-1.5 text-xs font-medium text-[hsl(var(--high-emphasis))] shadow-sm hover:border-primary/40 hover:shadow-md"
          >
...
export default function OidcLogin() {
  ...
  const handleLogin = () => {
    ...
    const params = new URLSearchParams({
      ...
      redirect_uri: `${deriveLocalizationBaseUrl()}/oidc`,
      scope: "openId",
      state: "039849038",
