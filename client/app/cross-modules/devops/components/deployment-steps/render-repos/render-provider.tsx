          ...
          {providers.map((provider) => {
            ...
            return (
              <Button
                ...
                className={`flex w-[345px] items-center justify-center gap-2 rounded border border-border bg-background px-4 py-2 font-medium duration-200 hover:bg-secondary ${provider.name.toLowerCase()}`}
                type="button"
