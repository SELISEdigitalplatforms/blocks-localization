...
export class TranslationsListPage {
  ...
  async applyDateRangeFilter(filter: "create" | "lastUpdate", startDay: number, endDay: number) {
    const trigger = filter === "create" ? this.createDateFilter : this.lastUpdateDateFilter;
