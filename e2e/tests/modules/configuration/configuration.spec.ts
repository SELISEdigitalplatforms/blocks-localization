...
test.describe("Configuration", () => {
  ...
  test("languages, default switch, webhook, add and delete language", async ({
    page,
  }) => {
    ...
    const webhookUrl =
      process.env.E2E_WEBHOOK_URL ??
      "https://webhook.site/28986105-6782-4ea8-92f9-6e9a81f74274"
    const webhookHeaderKey =
      process.env.E2E_WEBHOOK_HEADER_KEY ??
      "28986105-6782-4ea8-92f9-6e9a81f74274"
