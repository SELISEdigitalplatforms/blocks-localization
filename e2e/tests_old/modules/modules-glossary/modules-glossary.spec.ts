...
import { GlossaryFormPage, GlossaryListPage } from "../../../support/pages/glossary";
import { ModuleDetailsPage, ModulesListPage } from "../../../support/pages/modules";
...
test.describe("Modules & Glossary", () => {
  ...
  test("add glossary, tag to module, delete glossary, verify untagged", async ({ page }) => {
